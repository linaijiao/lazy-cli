...
Vue.use(Meta, {
  ...
  attribute: 'data-lazy-head', // the attribute name vue-meta adds to the tags it observes
  ssrAttribute: 'data-lazy-ssr', // the attribute name that lets vue-meta know that meta info has already been server-rendered
